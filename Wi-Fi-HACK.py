...
print('''
\033[1;92m Recoded By INTROVERTBOY TUSHAR
Telegram:https://t.me/INTROVERTBOYTUSHAR
One Line Command:\nsudo python DT-Wi-Fi-HACK/Wi-Fi-HACK.py -i wlan0 -K\n
For Help Type:\npython DT-Wi-Fi-HACK/Wi-Fi-HACK.py --help\033[0m
''')
...
def usage():
    return """
OneShotPin 0.0.2 (c) 2017 rofl0r, Modded by IT TusHar
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='OneShotPin 0.0.2 (c) 2017 rofl0r, Modded by IT TusHar',
